...
const props = defineProps<
    HTMLAttributes & { ledger: Ledger; active?: boolean }
>();

// let { ledger, class: classname, active = false, ...rest }: Props =define();
</script>
...
<template>
    ...
    >
        ...
        <div
            class="h-4 rounded flex items-center gap-2 text-xs w-full text-muted"
        >
